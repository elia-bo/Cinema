...
namespace Cinema.Migrations
{
    ...
    [Migration("20220506123337_ThirdMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cinema.Domain.Assegnamento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("IdSpettatore");

                    b.ToTable("Assegnamento");
                });
            ...
            modelBuilder.Entity("Cinema.Domain.Assegnamento", b =>
                {
                    b.HasOne("Cinema.Domain.Sala", "Sala")
                        .WithMany("Assegnamenti")
                        .HasForeignKey("IdSala")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cinema.Domain.Spettatore", "Spettatore")
                        .WithMany("Assegnamenti")
                        .HasForeignKey("IdSpettatore")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
